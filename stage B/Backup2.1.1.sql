...
prompt Created by owner on יום שישי 21 יוני 2024
set feedback off
set define off
...
alter table ASSET disable constraint SYS_C007606;
prompt Disabling foreign key constraints for DEBT...
alter table DEBT disable constraint SYS_C007613;
prompt Disabling foreign key constraints for DISCOUNT...
alter table DISCOUNT disable constraint SYS_C007629;
prompt Disabling foreign key constraints for OWNERSHIP...
alter table OWNERSHIP disable constraint SYS_C007633;
alter table OWNERSHIP disable constraint SYS_C007634;
prompt Disabling foreign key constraints for PAYMENT...
alter table PAYMENT disable constraint SYS_C007642;
...
insert into DEBT (debt_id, debt_price, debt_create, debt_last_date, tax_id)
values (6737469921, 136, to_date('18-05-2017', 'dd-mm-yyyy'), to_date('06-07-2023', 'dd-mm-yyyy'), 3814719621);
insert into DEBT (debt_id, debt_price, debt_create, debt_last_date, tax_id)
...
alter table ASSET enable constraint SYS_C007606;
prompt Enabling foreign key constraints for DEBT...
alter table DEBT enable constraint SYS_C007613;
prompt Enabling foreign key constraints for DISCOUNT...
alter table DISCOUNT enable constraint SYS_C007629;
prompt Enabling foreign key constraints for OWNERSHIP...
alter table OWNERSHIP enable constraint SYS_C007633;
alter table OWNERSHIP enable constraint SYS_C007634;
prompt Enabling foreign key constraints for PAYMENT...
alter table PAYMENT enable constraint SYS_C007642;
