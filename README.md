...
<p align="middle">
<img src="https://github.com/Tehila-David/DBProject_324926419_324866037/blob/main/Photos/DSD_%D7%9E%D7%A9%D7%95%D7%AA%D7%A3%20%D7%9C%D7%90%D7%97%D7%A8%20%D7%90%D7%99%D7%A0%D7%98%D7%92%D7%A8%D7%A6%D7%99%D7%94.PNG" width="80%">
</p>
...
#### תיאור מילולי 
סוף שנת לימודים ובמחלקת גביה החליטו לצפות בחשבונות ארנונה עבור מוסדות חינוך עקב שינויים בגובה הארנונה שהעירייה החליטה להעביר רק עבור נכסים שהם מהווים מוסדות חינוך. הם רוצים לדעת מי המנהל של המוסד החינוכי על מנת לעדכן אותו בשינויים.
השדות שיוצגו: מזהה מנהל, מזהה מוסד, מזהה נכס(מוסד חינוכי), כתובת נכס, סוג נכס, מזהה חשבון ארנונה, מחיר חשבון ארנונה.
...
#### תיאור מילולי 
לקראת סוף שנה אגף חינוך בירושלים מעוניין לדעת מיהם המוסודת החינוכיים בעיר, את כמות התלמידים בכל מוסד ומי מנהל אותם על מנת להמשיך לתחזק מוסודות אלו.
השדות שיוצגו: מזהה מוסד, שם מוסד, סוג מוסד, כמות תלמידים במוסד, כמות מורים במוסד, שם פרטי ומשפחה של המנהל, מס' טלפון מנהל ותאריך יום הולדת מנהל.
#### שליפת נתונים
```SQL
